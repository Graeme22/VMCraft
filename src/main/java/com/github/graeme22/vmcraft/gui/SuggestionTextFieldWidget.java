...
public class SuggestionTextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
	...
	private BiFunction<String, Integer, String> textFormatter = (p_195610_0_, p_195610_1_) -> { return p_195610_0_; };
	private static List<SuggestionTextFieldWidget> group = new ArrayList<>();
	
	public SuggestionTextFieldWidget(FontRenderer fontIn, int xIn, int yIn, int widthIn, int heightIn, String msg) {
		this(fontIn, xIn, yIn, widthIn, heightIn, (TextFieldWidget)null, msg);
	}
	
	public SuggestionTextFieldWidget(FontRenderer fontIn, int xIn, int yIn, int widthIn, int heightIn, @Nullable TextFieldWidget p_i51138_6_, String msg) {
	...
	public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
		if (this.getVisible()) {
			...
			if (!flag2 && this.suggestion != null && !this.isFocused() && this.text.length() == 0) {
	...
	protected void setFocused(boolean set) {
		...
		for(SuggestionTextFieldWidget w : SuggestionTextFieldWidget.group) {
			w.setFocused(false);
		}
